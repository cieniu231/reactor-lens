    ...
    render() {
        return (
            <div id="landing-page" style={{marginTop : '20px' }}>
                <div id='carrousel' style={{width : '100%',height : '400px', overflow : 'hidden', position : 'relative', background : ' linear-gradient(0deg, rgba(61,58,175,1), rgba(0,191,0,0.3)) ,url("images/carousel-img/paris.jpg")'}}>
